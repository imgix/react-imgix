...
describe('<source> type', () => {
  ...
  describe('with generateSrcSet', () => {
    beforeEach(() => {
      tree = sd.shallowRender(<Imgix src={src} type="source" generateSrcSet aggressiveLoad imgProps={imgProps} />);
      vdom = tree.getRenderOutput();
      instance = tree.getMountedInstance();
    });
...
describe('background type without backgroundSize', () => {
  beforeEach(() => {
    tree = sd.shallowRender(
      <Imgix src={src} type="bg" imgProps={{ style: { backgroundSize: null } }} aggressiveLoad />
    );
    vdom = tree.getRenderOutput();
    instance = tree.getMountedInstance();
  });
...
describe('background type with background contain', () => {
  beforeEach(() => {
    tree = sd.shallowRender(
      <Imgix src={src} type="bg" imgProps={{ style: { backgroundSize: 'contain' } }} aggressiveLoad />
    );
    vdom = tree.getRenderOutput();
    instance = tree.getMountedInstance();
  });
...
describe('custom component', () => {
  beforeEach(() => {
    tree = sd.shallowRender(<Imgix src={src} component="li" type="bg" aggressiveLoad />);
    vdom = tree.getRenderOutput();
    instance = tree.getMountedInstance();
  });
...
describe('image props', () => {
  ...
  beforeEach(() => {
    tree = sd.shallowRender(
      <Imgix src={src} auto={['format', 'enhance']} className={className} aggressiveLoad faces />
    );
    vdom = tree.getRenderOutput();
    instance = tree.getMountedInstance();
  });
  ...
  it('height passed to url param', () => {
    const height = 300;
    tree = sd.shallowRender(<Imgix src={'https://mysource.imgix.net/demo.png'} aggressiveLoad height={height} />);
    vdom = tree.getRenderOutput();
  ...
  it('width passed to url param', () => {
    const width = 300;
    tree = sd.shallowRender(<Imgix src={'https://mysource.imgix.net/demo.png'} aggressiveLoad width={width} />);
    vdom = tree.getRenderOutput();
  ...
  it('accepts any prop passed to imgProps', () => {
    ...
    tree = sd.shallowRender(<Imgix src={'https://mysource.imgix.net/demo.png'} imgProps={imgProps} />);
    vdom = tree.getRenderOutput();
